...
def train(input_path:str, output_path:str, config:dict, render:bool):
    ...
    for path in input_path_list:
        ...
        state, final_loss = image_field.train_loop(
        ...
        if render:
            rendered_image = image_field.render_image(state, image.shape[0], image.shape[1])
...
def main():
    ...
    parser.add_argument('--config_path', type=str, default='configs/image_field.json')
